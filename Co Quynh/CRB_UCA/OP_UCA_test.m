...
for Nr_index=1:Nr;
Br_fading = spec_chan_derive_fading_UCA(fading,delay,DOA,R_nor,Nr_index,Nr,L,M,Nt);
dev_h_fading=[dev_h_fading; transpose(Br_fading)];

Br_delay = spec_chan_derive_delay_UCA(fading,delay,DOA,R_nor,Nr_index,Nr,L,M,Nt);
dev_h_delay=[dev_h_delay; transpose(Br_delay)];

Br_angle = spec_chan_derive_angle_UCA(fading,delay,DOA,R_nor,Nr_index,Nr,L,M,Nt);
